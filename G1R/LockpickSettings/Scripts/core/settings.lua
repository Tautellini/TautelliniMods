-- settings.lua -- tiny persistence: load/save a Lua settings table to a file (the
-- menu/hotkey adjustments, so they survive a restart). stdlib only, no UE4SS globals;
-- main supplies the absolute path.
...
function M.save(path, tbl)
    return (pcall(function()
        ...
        fh:write("-- Saved LockpickSettings adjustments. Overrides config.lua;"
            .. " delete to reset.\n")
